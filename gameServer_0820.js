...
, sessionNo = 200 // 0 = debug; 100~ = 30&31 July; 200~ = August
, maxGroupSize = 8//7 // maximum 12
, minGroupSize = 4//3
, maxWaitingTime = 3*60*1000//3*60*1000
...
, numOptions = 2
, exp_condition_list = ['binary', 'gaussian']
, prob_binary = 1.0//0.8
...
roomStatus[firstRoomName] = {
    ...
    riskDistributionId: 6, //getRandomIntInclusive(max = 7, min = 5), // max = 2, min = 0
    isLeftRisky: isLeftRisky_list[getRandomIntInclusive(max = 1, min = 0)],
    indivOrGroup: -1,
    n: 0,
    membersID: [],
...
server.listen(port, function() {
	...
	logtxt += ' - Two-armed bandit task server listening on port ' + port + '; max_n_per_rooom = '+maxGroupSize;
	console.log(logtxt);
});
