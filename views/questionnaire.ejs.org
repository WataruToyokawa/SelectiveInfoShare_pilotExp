...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      const exp_condition = <%- JSON.stringify(exp_condition) %>;
      const indivOrGroup = <%- JSON.stringify(indivOrGroup) %>;
      const completed = <%- JSON.stringify(completed) %>;
    </script>
    <script type="text/javascript" src="/javascripts/questionnaireForm.js"></script>
  </head>
  <body>
    <div id='wrap'>
    <!--<form id="questionForm" name="questionForm" action="http://localhost:8000/endPage" method="POST">-->
    <form id="questionForm" name="questionForm" action="http://tk2-261-40415.vs.sakura.ne.jp:8000/endPage" method="POST">  
      <h1>Questionnaire</h1>
      ...
      <div id="task1">
       <h3>Q1: While working on the game, to what extent did you pay attention to the 'total earning' shown in upper-left of the screen?</h3>
       <table class='questionRadio'>
        ...
        <h3>Q2: While working on the game, to what extend did you pay attention to the "last round's sum"?</h3>
       <table class='questionRadio'>
        <tr>
          <th>Not at all</th>
          <th>Very little </th>
       ...
       <h3>Q3: While working on the game, to what extend did you pay attention to the payoff from each choice shown with the colored symbols?</h3>
       <table class='questionRadio'>
        <tr>
          <th>Not at all</th>
          <th>Very little </th>
       ...
       <h3>Q4: While working on the game, how did you try to increase your total profit? What kind of strategy did you take? Please write down any thoughts in the form below: </h3>
        <textarea class='answer' id='q4' name="q4" cols="50" rows="4"></textarea>
      ...
      <select id='country' name='country'>
        ...
        <option value="Zimbabwe">Zimbabwe</option>
              ...
              <!-- 実験で取った個人の行動データ -->
              <input type="hidden" id="amazonID" name="amazonID" value="">
    ...
    <!--<h1>Questionnaire</h1>
    <p>amazonID: <%= amazonID %></p>
    <p>bonus_for_waiting: <%= bonus_for_waiting %></p>
    <p>totalEarning: <%= totalEarning %></p>
    <p>confirmationID: <%= confirmationID %></p>
    <p>exp_condition: <%= exp_condition %></p>-->
    <div id='proceed'>
    </div>
  </body>
</html>
