...
const clone = (curve, angle = 0) => {
    return new Phaser.Curves.CubicBezier(curve.p0.clone().rotate(Phaser.Math.DEG_TO_RAD * angle), curve.p1.clone().rotate(Phaser.Math.DEG_TO_RAD * angle), curve.p2.clone().rotate(Phaser.Math.DEG_TO_RAD * angle), curve.p3.clone().rotate(Phaser.Math.DEG_TO_RAD * angle));
};
